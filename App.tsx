...
export default function App() {
  ...
  const generatePasswordSting = (passwordLength: number) => {
    let characterList = '';
      ...
      <SafeAreaView style={styles.appContainer}>
        ...
        <View style={styles.formContainer}>
            <Formik
              ...
              onSubmit={values => {
                console.log(values);
                generatePasswordSting(Number(values.passwordLength)); // or we can write as : generatePasswordString(+values.passwordLength)
              }}>
              {({
                values,
                errors,
